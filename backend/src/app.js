...
const wfhRoutes = require('./routes/hrms/wfh');
const ipRestrictionRoutes = require('./routes/auth/ipRestriction');
...
const independentTaskRoutes = require('./routes/projects/independentTasks');
...
const shiftRoutes = require('./routes/hrms/shifts');
...
router.use('/api/independent-tasks', independentTaskRoutes);
...
router.use('/api/organizations/ip-restrictions', ipRestrictionRoutes);
router.use('/api/hrms/wfh', wfhRoutes);
...
router.use('/api/hrms/shifts', shiftRoutes);
