...
export default function CalendarPage() {
  ...
  }, [rawEvents, debouncedSearchQuery, calendarMode, profile?.id, showHolidays, showBirthdays, showWorkEvents]);
        ...
        <div className="px-6 py-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <Button
                className="gap-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold rounded-xl shadow-md shadow-blue-500/10 hover:shadow-blue-500/25 transition-all duration-300 active:scale-[0.98] shrink-0"
                onClick={() => {
              ...
              <div className="relative max-w-xs">
                ...
                <Input
                  ...
                  className="pl-9 bg-secondary/60 border-transparent hover:bg-secondary focus-visible:bg-background focus-visible:ring-2 focus-visible:ring-blue-500/20 focus-visible:border-blue-500 rounded-xl transition-all"
                  value={searchQuery}
                ...
                {isLoading ? (
                  <div className="flex items-center justify-center h-96">
                    <div className="text-center">
                      <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600 mx-aut0 mb-4"></div>
              ...
              {calendarMode === "personal" && (
                <div className="p-6 space-y-6">
                  ...
                  <div className="space-y-3">
                    <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-wider">Event Filters</h3>
                    <div className="space-y-2">
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs font-semibold">Work Events</span>
                        </div>
                  ...
                  <div className="space-y-4">
                    <h3 className="text-sm font-bold text-foreground">Calendar Connections</h3>

                    {hasConnectedCalendar ? (
                      <div className="space-y-2">
                        {connections.map((conn) => (
                          <div key={conn.id} className="flex items-center justify-between p-3 bg-secondary/35 border border-border/40 rounded-xl">
                            <div className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-emerald-500 rounded-full"></div>
                              <span className="text-xs font-semibold text-foreground/90">{providerNames[conn.provider] || conn.provider}</span>
                            </div>
                        ...
                        <Button
                          className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold rounded-xl shadow-md"
