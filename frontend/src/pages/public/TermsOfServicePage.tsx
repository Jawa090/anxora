        ...
        <div className="p-8 sm:p-10 rounded-2xl bg-slate-900/40 border border-slate-800/80 backdrop-blur-sm space-y-10 text-slate-300 leading-relaxed shadow-xl">
          <section>
            ...
            <p className="text-slate-300 leading-relaxed">
              By accessing or using ELINA ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you disagree with any part of these terms, you may not access the Service. These Terms apply to all visitors, users, and others who access or use the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-300 leading-relaxed mb-3">
              ELINA is a multi-tenant CRM and business management platform that provides:
            </p>
          ...
          <section>
            ...
            <p className="text-slate-300 leading-relaxed">
              The Service, including software, design, text, graphics, and underlying source code, is owned by ELINA and protected by copyright, trademark, and other intellectual property laws. You retain ownership of all business data uploaded to your tenant.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-300 leading-relaxed">
              In no event shall ELINA, its directors, employees, or partners be liable for indirect, incidental, special, consequential, or punitive damages resulting from your use of or inability to use the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="p-5 rounded-xl bg-slate-950/70 border border-slate-800/80 text-sm">
              <p className="font-semibold text-white">ELINA Legal Team</p>
